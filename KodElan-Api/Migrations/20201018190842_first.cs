        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IntervalAmount = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "VacancyActivity",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Day = table.Column<int>(maxLength: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacancyActivity", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<byte>(maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Day = table.Column<int>(maxLength: 2, nullable: false),
                    Price = table.Column<int>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatingModeId = table.Column<int>(nullable: false),
                    MinSalaryId = table.Column<int>(nullable: false),
                    AboutEducation = table.Column<string>(nullable: true),
                    previousWorks = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CVs_Salaries_MinSalaryId",
                        column: x => x.MinSalaryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirementsCandidate = table.Column<int>(nullable: false),
                    RelevantPerson = table.Column<string>(maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vacancies_Duties_DutyId",
                        column: x => x.DutyId,
                        principalTable: "Duties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vacancies_Salaries_MinSalaryId",
                        column: x => x.MinSalaryId,
                        principalTable: "Salaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vacancies_OperatingModes_OperatingModeId",
                        column: x => x.OperatingModeId,
                        principalTable: "OperatingModes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CVBookmarks", x => new { x.UserId, x.CVId });
                    table.ForeignKey(
                        name: "FK_CVBookmarks_CVs_CVId",
                        column: x => x.CVId,
                        principalTable: "CVs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CVBookmarks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacancyBookmarks", x => new { x.UserId, x.VacancyId });
                    table.ForeignKey(
                        name: "FK_VacancyBookmarks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VacancyBookmarks_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vacancies_MinSalaryId",
                table: "Vacancies",
                column: "MinSalaryId");

            migrationBuilder.CreateIndex(
                name: "IX_Vacancies_OperatingModeId",
                table: "Vacancies",
                column: "OperatingModeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacancyBookmarks_VacancyId",
                table: "VacancyBookmarks",
                column: "VacancyId");
        }
